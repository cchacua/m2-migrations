...
DROP TABLE IF EXISTS patstat2016b.TLS206_PERSON_APPLNID_COUNTRY_ATLEASTONEUSA_F;
CREATE TABLE patstat2016b.TLS206_PERSON_APPLNID_COUNTRY_ATLEASTONEUSA_F AS
...
/*
Query OK, 1.181.141 rows affected (1 min 33,89 sec)
...
BY NOW, If there is a missing value, I will omited from the sample (so, if some inventors do not have the country information, but all the other members of the team come from the US, there are NOT going to be considered in the sample 
*/
...
/*
Query OK, 1.178.805 rows affected (1 min 18,75 sec)
...
/*
Query OK, 967413 rows affected (19,46 sec)
