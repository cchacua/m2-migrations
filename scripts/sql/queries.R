...
q2<- dbSendQuery(riccaboni, "SELECT RIGHT(riccaboni.t01.pat, LENGTH(riccaboni.t01.pat)-2) AS pat, riccaboni.t01.invs, riccaboni.t01.localInvs, riccaboni.t01.apps, riccaboni.t01.yr, riccaboni.t01.classes, riccaboni.t01.wasComplete FROM riccaboni.t01  LIMIT 1000, 1100;")
apn<-dbFetch(q2)
dbClearResult(q2)


q3<- dbSendQuery(riccaboni, "SELECT riccaboni.t01.pat FROM riccaboni.t01;")
ric.pn<-dbFetch(q3,  n = -1)
dbClearResult(q3)
